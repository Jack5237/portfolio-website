          ...
          <div className="space-y-6 sm:space-y-8 text-sm sm:text-base leading-relaxed text-foreground">
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <li>
                  Other service providers that help us operate the website
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                <li>
                  View what cookies you have and delete them on a one-by-one
                  basis
                </li>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                may not function properly. Essential cookies are necessary for
                the website to work, so disabling all cookies may limit your
