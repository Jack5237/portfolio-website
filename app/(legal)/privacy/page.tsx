...
export const metadata: Metadata = {
  ...
  description: "Privacy policy for Jack's portfolio website. Learn how your data is collected, used, and protected.",
          ...
          <div className="space-y-6 sm:space-y-8 text-sm sm:text-base leading-relaxed text-foreground">
            ...
            <section className="space-y-4">
              ...
              <ul className="list-disc list-inside space-y-2 text-muted-foreground ml-4">
                ...
                <li>
                  Send you updates and newsletters (if you have subscribed)
                </li>
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                ...
                through your browser settings. For more details, please see our{" "}
                <a
                  href="/cookies"
